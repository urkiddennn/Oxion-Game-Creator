...
export const styles = StyleSheet.create({
  ...
  inspectorSectionCompact: { backgroundColor: theme.colors.surface, borderRadius: 4, marginBottom: 8, borderWidth: 1, borderColor: theme.colors.border, overflow: 'hidden' },
  ...
  spriteSelectButtonCompact: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surfaceElevated, padding: 8, borderRadius: 4, gap: 10 },
  ...
  logicChainContainer: { marginBottom: 16, padding: 8, backgroundColor: '#1E2228', borderRadius: 4, borderWidth: 1, borderColor: '#333' },
  ...
  logicBlock: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#2E333D', padding: 8, borderRadius: 4, borderWidth: 1, borderColor: '#444' },
